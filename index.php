      ...
      <div class="container-fluid p-0">
         <div class="ctaSec-main wow fadeInUp"  data-wow-delay="0.4s">
            <ul>
               ...
               <li>
                  <div class="icon">
                     <svg width="53px" height="53px">
                        <path fill="currentColor" d="M25.586,-0.000 L18.885,18.885 L-0.000,25.586 L20.103,35.942 L28.023,53.000 L34.724,36.552 L53.000,26.195 L33.506,18.885 L25.586,-0.000 Z" />
                     </svg>
                  </div>
               </li>
